...
var CtrList = (function () {
    ...
    CtrList.prototype.search = function (term) {
        ...
        if (CtrList.hasTerm(term) && term.length >= this.ctrListMinSearchLength && this.term !== term) {
            ...
            this.searchTimer = Rx_1.Observable.timer(this.ctrListPause).subscribe(function () {
    ...
    CtrList.prototype.clear = function () {
        ...
        this.clearTimer = Rx_1.Observable.timer(globals_1.CLEAR_TIMEOUT).subscribe(function () {
            _this._clear();
        });
    };
    ...
    CtrList = __decorate([
        ...
        __metadata('design:paramtypes', [ctr_completer_1.CtrCompleter, core_1.TemplateRef, core_1.ViewContainerRef, core_1.ChangeDetectorRef])
    ], CtrList);
    return CtrList;
}());
